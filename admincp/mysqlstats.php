...
<table id="torrenttable" border="1">
	<tr>
		...
		."<form method=\"post\" action=\"".$REL_SEO->make_link('action_admin','module','mysqlstats')."\">"
		...
		<tr>
			...
			<table id="torrenttable" border="0">
				...
				<tr>
					...
					<td bgcolor="#000000" align="right">&nbsp;<? echo join(' ', formatByteDown($serverStatus['Bytes_received'])); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo join(' ', formatByteDown($serverStatus['Bytes_received'] * 3600 / $serverStatus['Uptime'])); ?>&nbsp;</td>
				</tr>
				<tr>
					<td bgcolor="#000000">&nbsp;Послано&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo join(' ', formatByteDown($serverStatus['Bytes_sent'])); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo join(' ', formatByteDown($serverStatus['Bytes_sent'] * 3600 / $serverStatus['Uptime'])); ?>&nbsp;</td>
				</tr>
				<tr>
			...
			<table id="torrenttable" border="0">
				...
				<tr>
					...
					<td bgcolor="#000000" align="right">&nbsp;<? echo number_format($serverStatus['Aborted_connects'], 0, '.', ','); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo number_format(($serverStatus['Aborted_connects'] * 3600 / $serverStatus['Uptime']), 2, '.', ','); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo ($serverStatus['Connections'] > 0 ) ? number_format(($serverStatus['Aborted_connects'] * 100 / $serverStatus['Connections']), 2, '.', ',') . '&nbsp;%' : '---'; ?>&nbsp;</td>
				</tr>
				<tr>
					<td bgcolor="#000000">&nbsp;Отменено клиентами&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo number_format($serverStatus['Aborted_clients'], 0, '.', ','); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo number_format(($serverStatus['Aborted_clients'] * 3600 / $serverStatus['Uptime']), 2, '.', ','); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo ($serverStatus['Connections'] > 0 ) ? number_format(($serverStatus['Aborted_clients'] * 100 / $serverStatus['Connections']), 2 , '.', ',') . '&nbsp;%' : '---'; ?>&nbsp;</td>
				</tr>
				<tr>
					<td bgcolor="lightgrey">&nbsp;Всего&nbsp;</td>
	...
	<table border="0">
		<tr>
			...
			<table id="torrenttable" border="0" align="right">
				...
				<tr>
					<td bgcolor="#000000" align="right">&nbsp;<? echo number_format($serverStatus['Questions'], 0, '.', ','); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo number_format(($serverStatus['Questions'] * 3600 / $serverStatus['Uptime']), 2, '.', ','); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo number_format(($serverStatus['Questions'] * 60 / $serverStatus['Uptime']), 2, '.', ','); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo number_format(($serverStatus['Questions'] / $serverStatus['Uptime']), 2, '.', ','); ?>&nbsp;</td>
				</tr>
			</table>
			</td>
		</tr>
		<tr>
			...
			<table id="torrenttable" border="0">
				...
				foreach ($queryStats as $name => $value) {
					...
					?>
				<tr>
					<td bgcolor="#000000">&nbsp;<? echo htmlspecialchars($name); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo number_format($value, 0, '.', ','); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo number_format(($value * 3600 / $serverStatus['Uptime']), 2, '.', ','); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo number_format(($value * 100 / ($serverStatus['Questions'] - $serverStatus['Connections'])), 2, '.', ','); ?>&nbsp;%&nbsp;</td>
				</tr>
				<?
	...
	<table border="0">
		<tr>
			...
			<table id="torrenttable" border="0">
				...
				<tr>
					<td bgcolor="#000000">&nbsp;<? echo htmlspecialchars(str_replace('_', ' ', $name)); ?>&nbsp;</td>
					<td bgcolor="#000000" align="right">&nbsp;<? echo htmlspecialchars($value); ?>&nbsp;</td>
				</tr>
				<?
				$useBgcolorOne = !$useBgcolorOne;
