...
class REL_TPL extends Smarty {
    ...
    function stdhead($title = "", $descradd = '', $keywordsadd = "", $headadd = '') {
        ...
        $this->assign('IS_POWER_USER',get_user_class() >= UC_POWER_USER);
		$this->assign('IS_HEAD',get_user_class() >= UC_HEAD);
		$this->assign('IS_POWER_HEAD',get_user_class() >= UC_POWER_HEAD);
