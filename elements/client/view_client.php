...
$res=sql_query("
SELECT callback.added,callback.next_call, callback.id_product, callback.type_contact, callback.comment,callback.id_user, users.name as u_name, result_call.text as rc_name
FROM `callback`
